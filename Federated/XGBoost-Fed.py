...
def main():
    ...
    # test model
    model_path = "../tree-based/workspaces/simulate_job/app_server/xgboost_model.json" ###this is the model file in json fomat that nvflare used, we have already trained in run.sh
